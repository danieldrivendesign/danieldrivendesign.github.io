...
function DarkModeToggle({themeCallback}: ITheme) {
    ...
    const LightThemeIcon = () => (
        <svg aria-hidden="true"
             xmlns="http://www.w3.org/2000/svg" width="38" height="38" fill="none" viewBox="0 0 24 24">
            <path stroke="cyan" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
    ...
    const DarkThemeIcon = () => (
        <svg aria-hidden="true"
             xmlns="http://www.w3.org/2000/svg" width="32" height="42" fill="none" viewBox="0 0 24 24">
            <path stroke="cyan" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
