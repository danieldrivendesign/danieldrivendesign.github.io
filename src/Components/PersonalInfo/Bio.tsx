    ...
    return (
        <>
            <div className={"font-mono"}>
                <div
                    className={`p-4 rounded-md text-justify dark:text-shadow-dark text-shadow-light`}>
                    <p>
                    ...
                    <p>
                        ...
                        over 2 years. I handle all kinds of software development tasks from a variety of clients, such as
                        ...
                        Systems Administrator for 8 years building servers, automating processes, and implementing
                        security features. Being in IT has been a blessing as well, and has helped me develop a mindset that
                        enforces
                    </p>
